...
$sql2="select * from deliverytable order by id desc";
...
if(isset($_POST['submit'])){
   // echo "hello";die;
    ...
    $sql="insert into deliverytable(name,email,phone,status) values('$name','$email','$phone','$status')";
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    <h4 class="col-sm-2 text-center">Enter Details</h4>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="tel" class="form-control"  name="phone" placeholder="Phone number Here">
                                        </div>
                                    </div>
