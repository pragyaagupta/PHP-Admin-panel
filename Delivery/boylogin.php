...
include('connection.php');
    ...
    if(isset($_POST['submit'])){
     ...
     $sql1="SELECT * FROM deliverytable WHERE email='$user_email' and password='$user_password'";
    //$res1=
  ...
  if(isset($_POST['lost'])){
     ...
     $sql2="SELECT * FROM delboy WHERE email='$user_email'";
            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        ...
                        <h3 style="color:white;">Delivery Boy Login-page</h3>
                    </div>
                    <!-- Form -->
