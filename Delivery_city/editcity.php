...
include('connection.php');
 ...
 $userId=$_POST['x'];
   ...
   $sql="SELECT * from citytable where city_id=$userId ";
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                       ...
                                       <li class="breadcrumb-item"><a href="city.php">City Table</a></li>
                            ...
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="tel" class="form-control"  value="<?php echo $row['pincode'];?>" name="pincode">
                                        </div>
                                    </div>
